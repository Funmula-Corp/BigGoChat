        ...
        cy.getLastPost().within((el) => {
            ...
            cy.get('.post-message__text').within(() => {
                ...
                cy.get('.emoticon').eq(1).parent().
                    should('have.html', `<span alt=":strawberry:" class="emoticon" data-testid="postEmoji.:strawberry:" style="background-image: url(&quot;${baseUrl}/static/emoji/1f353.png&quot;);">:strawberry:</span>`);
