...
//
//	LDFLAGS += -X "git.biggo.com/Funmula/BigGoChat/server/public/pluginapi/experimental/telemetry.rudderWriteKey=$(MM_RUDDER_WRITE_KEY)"
//
...
//
//	LDFLAGS += -X "git.biggo.com/Funmula/BigGoChat/server/public/pluginapi/experimental/telemetry.rudderDataPlaneURL=$(MM_RUDDER_DATAPLANE_URL)"
//
