...
func TestCheckAPIVersionComments(t *testing.T) {
	testCases := []struct {
		...
		{
			name:    "valid comments",
			pkgPath: "git.biggo.com/Funmula/mattermost-funmula/server/public/plugin/checker/internal/test/valid",
			err:     "",
		},
		{
			name:    "invalid comments",
			pkgPath: "git.biggo.com/Funmula/mattermost-funmula/server/public/plugin/checker/internal/test/invalid",
			expected: result{
		...
		},
		{
			...
			pkgPath: "git.biggo.com/Funmula/mattermost-funmula/server/public/plugin/checker/internal/test/missing",
			err:     "could not find API interface",
		},
		{
			name:    "non-existent package path",
			pkgPath: "git.biggo.com/Funmula/mattermost-funmula/server/public/plugin/checker/internal/test/does_not_exist",
			err:     "could not find API interface",
		},
	}
