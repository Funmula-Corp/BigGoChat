...
require (
	git.biggo.com/Funmula/mattermost-packages/grpc v0.0.0-20240531015220-e417ca8b4371 // indirect
	git.biggo.com/Funmula/mattermost-packages/pluginAPI v0.0.0-20240531023356-8868cd3d192c // indirect
