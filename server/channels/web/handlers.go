...
import (
	...
	app_opentracing "git.biggo.com/Funmula/BigGoChat/server/v8/channels/app/opentracing"
	"git.biggo.com/Funmula/BigGoChat/server/v8/channels/store/opentracinglayer"
