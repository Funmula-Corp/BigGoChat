...
func (_m *ChannelStore) GetAllChannelMembersForUser(ctx request.CTX, userID string, allowFromCache bool, includeDeleted bool) (map[string]*model.AllChannelMember, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(request.CTX, string, bool, bool) (map[string]*model.AllChannelMember, error)); ok {
		return rf(ctx, userID, allowFromCache, includeDeleted)
	}
	if rf, ok := ret.Get(0).(func(request.CTX, string, bool, bool) map[string]*model.AllChannelMember); ok {
