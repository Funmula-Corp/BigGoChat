...
func (_m *ChannelStore) GetAllChannelMembersForUser(userID string, allowFromCache bool, includeDeleted bool) (map[string]*model.AllChannelMember, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, bool, bool) (map[string]*model.AllChannelMember, error)); ok {
		return rf(userID, allowFromCache, includeDeleted)
	}
	if rf, ok := ret.Get(0).(func(string, bool, bool) map[string]*model.AllChannelMember); ok {
