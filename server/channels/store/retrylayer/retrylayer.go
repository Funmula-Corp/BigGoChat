...
func (s *RetryLayerBlocklistStore) ListTeamBlockUsersByBlockedUser(blockedId string) (*model.TeamBlockUserList, error) {
...
func (s *RetryLayerBlocklistStore) SaveTeamBlockUser(blockUser *model.TeamBlockUser) (*model.TeamBlockUser, error) {
...
func (s *RetryLayerChannelStore) GetAllChannelMembersForUser(ctx request.CTX, userID string, allowFromCache bool, includeDeleted bool) (map[string]*model.AllChannelMember, error) {
...
func (s *RetryLayerSessionStore) DropDeviceId(deviceId string) error {
...
func (s *RetryLayerTeamStore) GetAllTeamsByEmail(email string) ([]*model.Team, error) {
