...
func (s *TimerLayerChannelStore) GetAllChannelMembersForUser(userID string, allowFromCache bool, includeDeleted bool) (map[string]*model.ChannelMemberRolesAndExcludePermissions, error) {
	start := time.Now()
