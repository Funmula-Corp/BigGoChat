...
func GetMockStoreForSetupFunctions() *mocks.Store {
	...
	systemStore.On("GetByName", model.MigrationKeyRemoveChannelManageUserFromChannelUser).Return(&model.System{Name: model.MigrationKeyRemoveChannelManageUserFromChannelUser, Value: "true"}, nil)
