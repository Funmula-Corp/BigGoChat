...
const (
	Cluster_GetMyClusterInfo_FullMethodName         = "/gossip.Cluster/GetMyClusterInfo"
	Cluster_GetClusterStats_FullMethodName          = "/gossip.Cluster/GetClusterStats"
	Cluster_SendClusterMessageToNode_FullMethodName = "/gossip.Cluster/SendClusterMessageToNode"
	Cluster_GetLogs_FullMethodName                  = "/gossip.Cluster/GetLogs"
	Cluster_QueryLogs_FullMethodName                = "/gossip.Cluster/QueryLogs"
	Cluster_GetPluginStatuses_FullMethodName        = "/gossip.Cluster/GetPluginStatuses"
	Cluster_ConfigChanged_FullMethodName            = "/gossip.Cluster/ConfigChanged"
	Cluster_WebConnCountForUser_FullMethodName      = "/gossip.Cluster/WebConnCountForUser"
)
...
func (c *clusterClient) GetMyClusterInfo(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ClusterInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Cluster_GetMyClusterInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) GetClusterStats(ctx context.Context, in *Void, opts ...grpc.CallOption) (*ClusterStatsReply, error) {
	...
	err := c.cc.Invoke(ctx, Cluster_GetClusterStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) SendClusterMessageToNode(ctx context.Context, in *ClusterMessage, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, Cluster_SendClusterMessageToNode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) GetLogs(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogReply, error) {
	out := new(LogReply)
	err := c.cc.Invoke(ctx, Cluster_GetLogs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) QueryLogs(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*QueryLogReply, error) {
	...
	err := c.cc.Invoke(ctx, Cluster_QueryLogs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) GetPluginStatuses(ctx context.Context, in *Void, opts ...grpc.CallOption) (*PluginStatusReply, error) {
	...
	err := c.cc.Invoke(ctx, Cluster_GetPluginStatuses_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) ConfigChanged(ctx context.Context, in *ConfigUpdateRequest, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, Cluster_ConfigChanged_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clusterClient) WebConnCountForUser(ctx context.Context, in *WebsocketCountForUserRequest, opts ...grpc.CallOption) (*WebsocketCountForUserReply, error) {
	...
	err := c.cc.Invoke(ctx, Cluster_WebConnCountForUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Cluster_GetMyClusterInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cluster_GetMyClusterInfo_FullMethodName,
	}
