...
func (be *BiggoEngine) SearchPosts(channels model.ChannelList, searchParams []*model.SearchParams, page, perPage int) (result []string, matches model.PostSearchMatches, aErr *model.AppError) {
